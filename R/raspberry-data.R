...
#' These lists and tables are generated by Strawberry \url{https://github.com/ruolin/strawberry}, which is a cpp program that efficiently analyzes each RNA-Seq alignment file (BAM) and
